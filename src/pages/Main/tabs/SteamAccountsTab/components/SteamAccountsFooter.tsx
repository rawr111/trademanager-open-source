            ...
            <div className="footer">
                <div className='footer__wrapper'>
                    ...
                    <div className="footer__control">
                        ...
                        <Button style={{ minWidth: "140px" }} disabled={false}
                            view="default"
                            size="large"
                            color="grey"
                            hoverColor="grey"
                            img="./assets/img/Footer-start.svg"
                            hoverImg="./assets/img/Footer-start-hov.svg"
                            text="Запустить" />
                        <Button
                            ...
                            color="grey"
                            hoverColor="grey"
                            img="./assets/img/Footer-delete.svg"
                            hoverImg="./assets/img/Footer-delete-hov.svg"
                            text="Удалить"
                            onClick={() => {
